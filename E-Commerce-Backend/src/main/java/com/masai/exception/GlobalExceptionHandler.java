...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ErrorDetails> cartItemNotFoundExceptionHandler(CartItemNotFound cife, WebRequest wr){
		ErrorDetails err = new ErrorDetails(LocalDateTime.now(), cife.getMessage(), wr.getDescription(false));
	...
	public ResponseEntity<ErrorDetails> reviewExceptionHandler(ReviewException re, WebRequest wr){
